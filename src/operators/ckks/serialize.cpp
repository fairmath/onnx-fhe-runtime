...
CKKSLoaderKernel::CKKSLoaderKernel(OrtApi api, const OrtKernelInfo* info, std::shared_ptr<reg::CryptoRegistry> registry)
...
CKKSSaverKernel::CKKSSaverKernel(OrtApi api, const OrtKernelInfo* info, std::shared_ptr<reg::CryptoRegistry> registry)
    : api_(api), kinfo_(info), reg_(registry) {
